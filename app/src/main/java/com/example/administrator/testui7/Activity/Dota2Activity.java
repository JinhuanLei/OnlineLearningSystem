...
//        setActionBar();
        ...
        value = intent.getStringExtra("videoType");
        BmobQuery<Video> query = new BmobQuery<Video>();

        query.addWhereEqualTo("videoType", value);
        ...
        query.findObjects(new FindListener<Video>() {
            ...
            public void done(List<Video> list, BmobException e) {
                if(e==null){
                    ...
                    datas=list;
                    mAdapter=new MyRecyclerViewAdapter(Dota2Activity.this, datas);
                    ...
                    mAdapter.setOnItemClickListener(new MyRecyclerViewAdapter.OnRecyclerViewItemClickListener(){
                        ...
                        public void onItemClick(View view , String data){
                            ...
                            intent.setClass(Dota2Activity.this,VideoPlayActivity.class);
