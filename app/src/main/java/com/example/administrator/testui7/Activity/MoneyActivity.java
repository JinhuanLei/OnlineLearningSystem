    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_test).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                user.setMoney(20.0);
                user.setUserid(BmobUser.getCurrentUser().getObjectId());
                user.save(new SaveListener<String>() {
                    @Override
                    public void done(String objectId,BmobException e) {
                        if(e==null){
                            Toast.makeText(MoneyActivity.this,"添加数据成功，返回objectId为："+objectId, Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(MoneyActivity.this, "创建数据失败：" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        findViewById(R.id.btn_getmoney).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
