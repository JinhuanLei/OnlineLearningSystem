...
import com.example.administrator.testui7.Activity.Dota2Activity;
...
public class Image2Fragment extends Fragment{
    ...
    public void initData() {
        ...
        mFenquArray =new String[]{"计算机","数学","语 文","物 理","英 语","马克思","dota2","娱 乐","科 学","化 学","生 物","文学鉴赏"};
        ...
        mAdapter.setOnItemClickListener(new FenquAdapter.OnRecyclerViewItemClickListener(){
                                            ...
                                            public void onItemClick(View view, String data) {
                                                ...
                                                //在Intent对象当中添加一个键值对
                                                intent.putExtra("videoType", data);
                                                intent.setClass(getActivity(),Dota2Activity.class);
