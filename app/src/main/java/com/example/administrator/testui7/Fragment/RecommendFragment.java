...
import com.example.administrator.testui7.Activity.RegisterActivity;
import com.example.administrator.testui7.Activity.VideoInfoActivty;
import com.example.administrator.testui7.Activity.VideoPlayActivity;
                ...
                if(e==null){
                    ...
                    mAdapter.setOnItemClickListener(new VideoAdapter.OnItemClickListener() {
                        ...
                        public void OnItemClik(View view, int position) {
                           ...
                           String str= mDatas.get(position).getObjectId();
                            Intent intent = new Intent();
                            //在Intent对象当中添加一个键值对
                            intent.putExtra("vedioObjectId", str);
